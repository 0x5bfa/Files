...
- out-of-process COM integration
...
├─ docs/                        Shared human- and agent-readable project docs
├─ packages/                    NuGet-expanded native packages for C++ projects
├─ src/                         Source projects
├─ tests/                       Test projects
├─ AGENTS.md                    Shared AI-agent entry point
├─ CLAUDE.md                    Claude-specific thin wrapper
...
├─ Files.App (Package)/         Packaging project wrapper
...
├─ Generated Files/ Generated outputs; do not edit directly
...
Packaging wrapper for MSIX-related tooling. This project is part of build and publish flows, not a place for feature logic.
...
└─ Generated Files/   Generated support code
```
