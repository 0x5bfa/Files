...
/// <summary>
/// Describes the geometry and intrinsic size of a <see cref="ThemedIcon2"/>.
/// </summary>
public sealed class ThemedIcon2Data
{
	internal static ThemedIcon2Data Default { get; } = new()
	{
		Size = 16,
	...
	public IList<ThemedIcon2Layer> Layers { get; } = [];
}
