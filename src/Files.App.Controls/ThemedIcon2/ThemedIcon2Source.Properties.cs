...
public sealed partial class ThemedIcon2Source
{
	/// <summary>Gets or sets the geometry displayed by created icons.</summary>
	[GeneratedDependencyProperty]
	public partial ThemedIcon2Data? Data { get; set; }
	...
	/// <summary>Gets or sets the rendered size, or <see cref="double.NaN"/> to use <see cref="ThemedIcon2Data.Size"/>.</summary>
	...
	partial void OnDataChanged(ThemedIcon2Data? newValue)
	{
		UpdateDataSource();
	}
