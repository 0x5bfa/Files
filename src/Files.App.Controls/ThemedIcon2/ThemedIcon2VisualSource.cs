...
internal sealed class ThemedIcon2VisualSource : IAnimatedVisualSource2
{
	...
	private readonly ThemedIcon2Data _data;
	...
	public ThemedIcon2VisualSource(
		ThemedIcon2Data data, ThemedIconTypes iconType, ThemedIconColorType iconColorType, bool isFilled, bool isToggled, bool isEnabled, bool isHighContrast,
	...
	private static LayerDefinition[] CreateLayers(ThemedIcon2Data data, IconVariant variant)
	{
	...
	private static Color GetResourceColor(string resourceKey, Color fallback, ElementTheme theme, bool useThemeResources)
	{
		...
		if (Application.Current is not null && TryGetResourceValue(Application.Current.Resources, resourceKey, theme, out var value))
		{
			return value switch
			{
				Color color => color,
	...
	private static bool TryGetResourceValue(ResourceDictionary dictionary, string resourceKey, ElementTheme theme, out object? value)
	{
		...
		if (themeKey is not null &&
			dictionary.ThemeDictionaries.TryGetValue(themeKey, out var themeValue) &&
	...
	private static IconVariant GetActiveVariant(ThemedIcon2Data data, ThemedIconTypes iconType, bool isFilled, bool isToggled, bool isEnabled, bool isHighContrast)
	{
	...
	private IAnimatedVisual CreateAnimatedVisual(Compositor compositor)
	{
		...
		return new ThemedIcon2AnimatedVisual(root, new Vector2(_intrinsicSize, _intrinsicSize), geometries);
	}
	...
	private sealed class ThemedIcon2AnimatedVisual : IAnimatedVisual
	{
		...
		public ThemedIcon2AnimatedVisual(Visual rootVisual, Vector2 size, IReadOnlyList<CanvasGeometry> geometries)
		{
