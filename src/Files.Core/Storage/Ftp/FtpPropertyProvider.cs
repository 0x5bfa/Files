...
/// </summary>
public sealed class FtpPropertyProvider : IPropertyProvider
{
	...
	public FtpPropertyProvider(FtpStorageSource source)
	{
		...
		CancellationToken cancellationToken = default)
	{
		...
		foreach (var context in contexts.Where(CanProvide))
		{
